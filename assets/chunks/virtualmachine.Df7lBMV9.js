...
**中文：** 虚拟机 (VM) 表示托管在[集群](/projects/tech-share/netbox/4.5.1/community/data-model/virtualization/cluster)内的虚拟计算实例。每台 VM 必须分配至[站点](/projects/tech-share/netbox/4.5.1/community/data-model/dcim/site)和/或集群，可选择性分配至集群内特定宿主[设备](/projects/tech-share/netbox/4.5.1/community/data-model/dcim/device)。VM 可挂载虚拟[接口](/projects/tech-share/netbox/4.5.1/community/data-model/virtualization/vminterface)，不支持物理组件。当 VM 的接口分配了 IP 时，可指定主 IPv4/IPv6。
...
| **Role** | 功能[角色](/projects/tech-share/netbox/4.5.1/community/data-model/dcim/devicerole) | The functional role assigned to the VM |
...
| **Platform** | 操作系统[平台](/projects/tech-share/netbox/4.5.1/community/data-model/dcim/platform) | A VM may be associated with a platform to indicate its OS |
