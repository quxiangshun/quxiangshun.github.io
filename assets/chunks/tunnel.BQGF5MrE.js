...
**中文：** 隧道表示通过协议封装在共享基础设施上建立的两端或多端之间的私有虚拟连接。常见封装包括 GRE、IP-in-IP、IPSec。NetBox 支持点对点和 Hub-Spoke 拓扑。设备/虚拟机接口通过[隧道终止点](/projects/netbox/4.5.1/community/data-model/vpn/tunneltermination)与隧道关联。
...
| Group | 所属[隧道组](/projects/netbox/4.5.1/community/data-model/vpn/tunnelgroup) | The administrative group (optional) |
