...
**中文：** [虚拟机](/projects/tech-share/netbox/4.5.1/community/data-model/virtualization/virtualmachine)接口与设备[接口](/projects/tech-share/netbox/4.5.1/community/data-model/dcim/interface)类似：可分配 VRF、IP 地址、VLAN 等。但因虚拟属性，不具备物理特性（如物理类型、线缆连接）。
