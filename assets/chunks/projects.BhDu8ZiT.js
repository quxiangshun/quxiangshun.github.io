...
NetBox 是一个开源的网络基础设施管理和 IP 地址管理（IPAM）解决方案，专为网络工程师设计。

**文档入口**：[NetBox 4.5.1 Community](/projects/tech-share/netbox/4.5.1/community/) · [学习笔记](/projects/tech-share/netbox/customer/)

## 6. NewApi {#newapi}

[New API](https://github.com/QuantumNous/new-api) 是统一 AI 模型网关与资产管理系统，支持 OpenAI/Claude/Gemini 等格式转换与集中式模型管理。

**完整文档**：[项目介绍](/projects/newapi/introduction) · [插件开发](/projects/newapi/插件开发) · [日志插件](/projects/newapi/日志插件) · [usage_log 与上游合并（源码入侵）](/projects/newapi/usage_log与上游合并-源码入侵) · [分组与访问配置](/projects/newapi/分组与访问配置) · [模型](/projects/newapi/模型)
