...
本文档说明如何在 Ly Docs 项目中集成 Algolia 文档搜索（[全局搜索方案二](/projects/tech-share/global-search/)）。
...
\`\`\`bash
cd projects/tech-share/global-search
node generate.js
\`\`\`

输出：\`projects/tech-share/global-search/algolia-records.json\`
