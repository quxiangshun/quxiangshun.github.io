...
**中文：** IKE（Internet Key Exchange）策略定义 IKE 版本、模式及一组用于 IKE 协商的[提议](/projects/tech-share/netbox/4.5.1/community/data-model/vpn/ikeproposal)。由 [IPSec 配置文件](/projects/tech-share/netbox/4.5.1/community/data-model/vpn/ipsecprofile) 引用。
