...
**中文：** IPsec 策略定义用于建立 IPsec 隧道的一组[提议](/projects/netbox/4.5.1/community/data-model/vpn/ipsecproposal)，可选定义 PFS 组。由 [IPsec 配置文件](/projects/netbox/4.5.1/community/data-model/vpn/ipsecprofile) 引用。
