...
**中文：** L2VPN 对象表示二层桥接技术，如 VXLAN、VPLS、EPL。创建后可终止到[接口](/projects/netbox/4.5.1/community/data-model/dcim/interface)和 [VLAN](/projects/netbox/4.5.1/community/data-model/ipam/vlan)。
...
| Import/Export Targets | 关联的[路由目标](/projects/netbox/4.5.1/community/data-model/ipam/routetarget) | Route targets for forwarding info |
