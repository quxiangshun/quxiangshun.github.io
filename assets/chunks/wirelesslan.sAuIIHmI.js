...
**中文：** 无线 LAN 是一组通过共同无线信道连接的接口，由 SSID 和认证参数标识。无线[接口](/projects/netbox/4.5.1/community/data-model/dcim/interface)可与无线 LAN 关联，用于建模多接入无线网段。
...
| Group | 所属[无线 LAN 组](/projects/netbox/4.5.1/community/data-model/wireless/wirelesslangroup) | The wireless LAN group (optional) |
